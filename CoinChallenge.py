    ...
    def coinChange(self, coins: List[int], amount: int) -> int:
        ...
        for i in range(1, numberOfCoins + 1):
            ...
            for j in range(1, amount + 1):
                ...
                #else we compare the previous coin optimal way to reeach the target and current coin optimal way to reach  (target - current coin) value
                #plus adding 1 value of current coin. And we use the min optimal ways
